...
describe('Add expense', () => {
  ...
  describe('add a second expense',() => {
    ...
    it('can add an additional expense', () => {
      ...
      RECORD_FORM.clickPaidBy('testuser');
      RECORD_FORM.confirm();
      RECORD_LIST.RECORD_BY_COST('10').exists();
  ...
  describe('form',() => {
    ...
    it('error messages', () => {
      ...
      RECORD_FORM.CURRENCY.shouldHaveErrorOutline();
      RECORD_FORM.CURRENCY.set('SIT');
      RECORD_FORM.CURRENCY.shouldNotHaveErrorOutline();
      RECORD_FORM.CONFIRM_BUTTON.shouldBeDisabled();
      RECORD_FORM.COST.shouldHaveErrorOutline();
      RECORD_FORM.COST.set('10');
      RECORD_FORM.COST.shouldNotHaveErrorOutline();
      RECORD_FORM.CONFIRM_BUTTON.shouldBeDisabled();
